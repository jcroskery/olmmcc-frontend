...
<div id="main-text">
    <h1>FAQ</h1>
    <ul>
        <li>Q: When are choir practices?</li>
        ...
        <li>Q: What is the age requirement?</li>
        <li class='a'>A: Your child must be in grade 3 or above.</li>
        <li>Q: What are the duties of choir members?</li>
